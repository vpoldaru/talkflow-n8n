...
export const ChatMessage = ({ message }: ChatMessageProps) => {
  ...
  return (
    ...
    >
      <div
        className={cn(
          "max-w-[85%] rounded-2xl px-4 py-3 transition-all duration-200 backdrop-blur-sm hover:-translate-y-1 relative overflow-hidden",
          isAssistant
      ...
      >
        <div className="prose prose-slate dark:prose-invert max-w-none break-words text-left overflow-x-auto">
          {message.imageData && (
            <div className="mb-2">
              <img
